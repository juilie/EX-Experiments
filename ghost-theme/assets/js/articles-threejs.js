...
import { OutputPass } from 'three/addons/postprocessing/OutputPass.js';
  ...
  const NewsletterCloudShader = {
    ...
    // Articles are now rendered by Ghost CMS via Handlebars templates
    ...
    function loadCustomFont() {
      const font = new FontFace('Epmarugo', 'url(../fonts/epmarugo.ttf)');
    ...
    function createCloudImage() {
      ...
      img.src = `../images/ex${exNumber}.png`;
    ...
    // renderArticles() removed - articles are now rendered by Ghost CMS via Handlebars templates
...
setupNewsletterForm();
  ...
  // Color picker event listeners removed - DOM elements may not exist in Ghost theme